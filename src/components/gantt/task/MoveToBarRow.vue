  ...
  <div v-if='showRow'>
    <div style="width: 100%;border-top: 1px solid #cecece;margin:0px 0px -1px -1px;"></div>
      <div class="cell" :style= "{height:rowHeight +'px',width:'100%'}">
        <svg @click="event => goBarStart(event,row)" class="btn" width="18" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <svg @click="event => goBarEnd(event,row)" class="btn" width="18" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
